        ...
        <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
            ...
            <form method="post" class="am-form" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="am-form-group am-form-icon am-form-feedback {{ $errors->has('name') ? ' am-form-error' : '' }}">
                    ...
                    <input type="text" id="name" class="am-form-field" placeholder="输入你的昵称" name="name"
                           value="{{ old('name') }}">
                ...
                <div class="am-form-group am-form-icon am-form-feedback {{ $errors->has('username') ? ' am-form-error' : '' }}">
                    ...
                    <input type="text" id="username" class="am-form-field" placeholder="输入你的用户名" name="username"
                           value="{{ old('username') }}">
                ...
                <div class="am-form-group am-form-file">
                    ...
                    <div>
                        <img src="{{ old('avatar', 'https://images.itfun.tv/school/images/common/user_noimg.png') }}"
                             id="photo_show" style="max-height: 200px;">
                    </div>
                </div>
                <!-- ... -->
                ...
                <div class="am-cf">
                    ...
                    <a href="{{ route('login') }}" class="am-btn am-btn-default am-btn-sm am-fr">Already Has Account
                        ^_^?</a>
                </div>
            </form>
            <br>
